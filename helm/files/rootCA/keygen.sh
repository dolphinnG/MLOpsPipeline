...
openssl x509 -req -in my-org-new.csr -CA my-org.com.crt -CAkey my-org.com.key -CAcreateserial -out my-org-new.crt -days 365 -extensions v3_req -extfile dolphin.cnf